 ...
 */
@Component
public class PcAuthorizeConfigManagerImpl implements AuthorizeConfigManager {
     ...
     */
    @Autowired
    public PcAuthorizeConfigManagerImpl(List<AuthorizeConfigProvider> authorizeConfigProviders) {
