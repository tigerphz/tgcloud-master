package com.tiger.tgcloud.common.utils;
...
public class RedisKeyUtil {
     ...
     */
    private static final String RESET_PWD_TOKEN_KEY = "tgcloud:restPwd";
    private static final String ACTIVE_USER = "tgcloud:activeUser";
    private static final String SEND_SMS_COUNT = "tgcloud:sms:count";
    private static final String SEND_EMAIL_CODE = "tgcloud:email:code";
    private static final String ACCESS_TOKEN = "tgcloud:token:accessToken";
    private static final String UPLOAD_FILE_SIZE = "tgcloud:file:upload_file_size";
